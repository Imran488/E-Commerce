        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <a href="{{ route('admin.ban.customer',$user->id) }}" class="btn btn-danger"><i class="fa fa-window-close"></i></a>
                    @else
                    <a href="{{ route('admin.un.ban.customer',$user->id) }}" class="btn btn-success"><i class="fa fa-check"></i></a>
                    @endif
                </td>
                <td>
                    <a href="{{ route('admin.delete.customer',$user->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
